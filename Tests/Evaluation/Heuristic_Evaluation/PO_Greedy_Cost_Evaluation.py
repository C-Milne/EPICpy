...
class POGreedyCostEvaluation(unittest.TestCase):
    ...
    def test_00_PO_Rover_Breadth_First_No_Pruning(self):
        ...
        run_tests(tests, strats, "Rover_Partial_Order", False, partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_01_PO_Rover_Breadth_First(self):
        ...
        strats = [Strat("Breadth_First_Operations_PO_Pruning_GCost", PartialOrderPruning)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_02_PO_Rover_Hamming(self):
        ...
        strats = [Strat("Hamming_Distance_Partial_Order_GCost", HammingDistancePartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_03_PO_Rover_Tree(self):
        ...
        strats = [Strat("Tree_Distance_Partial_Order_GCost", TreeDistancePartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_04_PO_Rover_Delete_Relaxed(self):
        ...
        strats = [Strat("Delete_Relaxed_Partial_Order_GCost", DeleteRelaxedPartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_05_PO_Barman_Breadth_First_No_Pruning(self):
        ...
        strats = [Strat("Breadth_First_Operations_GCost", NoPruning)]
        run_tests(tests, strats, "Barman_Partial_Order", False, partial_order=True, SearchQueue=GreedyCostSearchQueue)
    ...
    def test_06_PO_Barman_Breadth_First(self):
        ...
        strats = [Strat("Breadth_First_Operations_PO_Pruning_GCost", PartialOrderPruning)]
        run_tests(tests, strats, "Barman_Partial_Order", partial_order=True, SearchQueue=GreedyCostSearchQueue)

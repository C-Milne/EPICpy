...
class POGBFSEvaluation(unittest.TestCase):
    ...
    def test_00_PO_Rover_Breadth_First_No_Pruning(self):
        ...
        run_tests(tests, strats, "Rover_Partial_Order", False, partial_order=True, SearchQueue=GBFSSearchQueue)
    ...
    def test_02_PO_Rover_Hamming(self):
        ...
        strats = [Strat("Hamming_Distance_Partial_Order_GBFS", HammingDistancePartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GBFSSearchQueue)
    ...
    def test_03_PO_Rover_Tree(self):
        ...
        strats = [Strat("Tree_Distance_Partial_Order_GBFS", TreeDistancePartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GBFSSearchQueue)
    ...
    def test_04_PO_Rover_Delete_Relaxed(self):
        ...
        strats = [Strat("Delete_Relaxed_Partial_Order_GBFS", DeleteRelaxedPartialOrder)]
        run_tests(tests, strats, "Rover_Partial_Order", partial_order=True, SearchQueue=GBFSSearchQueue)
    ...
    def test_05_PO_Barman_Breadth_First_No_Pruning(self):
        ...
        strats = [Strat("Breadth_First_Operations_GBFS", NoPruning)]
        run_tests(tests, strats, "Barman_Partial_Order", False, partial_order=True, SearchQueue=GBFSSearchQueue)

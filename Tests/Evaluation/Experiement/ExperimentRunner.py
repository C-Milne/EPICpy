...
def write_to_file(problem_name, number_expansions, solve_time, all_possible_facts, actual_facts, percentage_facts,
                  total_possible_pairs, total_actual_pairs, percentage_pairs, solved):
    file_name = 'Hamming-Distance-results.csv'
    if os.path.exists(file_name):
        ...
        write_file.write('Problem,number expansions,solve time,all_facts,actual_facts,percentage facts,possible_pairs,actual_paris,percentage pairs,Solved')
...
if __name__ == "__main__":
    ...
    run_test("../../Examples/Depots/domain.hddl", "../../Examples/Depots/p21.hddl")
